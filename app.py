...
app.layout = html.Div(
    ...
    children=[
        ...
        dcc.Store(id="ai-output-store", storage_type="session", data={}),  
...
{message}
    ...
    try:
        ...
        print("🔹 Logging in...")
        server.login("techshaho786@gmail.com", "hydyyuhhuztezdub") 

        print("🔹 Sending email...")
        server.sendmail("techshaho786@gmail.com", receiver_email, msg.as_string())
